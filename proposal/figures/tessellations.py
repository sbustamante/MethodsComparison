...
def voronoi(P):
    ...
    lines = matplotlib.collections.LineCollection(lines, color='k', linewidth = 2)
...
if __name__ == '__main__':
    ...
    fig.subplots_adjust( wspace=0.03, left = 0.01, right = 0.99, bottom = 0.01, top = 0.99 )

    #Original data set
    axes1 = plt.subplot(1,4,1)
    plt.scatter(X, Y, marker='o', s = size, linewidths = 1.5, color = "r", edgecolor='k')
    plt.xlim( (0,1) )
    plt.ylim( (0,1) )
    plt.xticks([],[])
    plt.yticks([],[])
    
    #Delaunay triangulation set
    axes2 = plt.subplot(1,4,2)
    plt.scatter(X, Y, marker='o', s = size, linewidths = 1.5, color = "r", edgecolor='k', zorder = 5)
    ...
    plt.scatter(X, Y, marker='o', s = 1500, alpha = 0.2, linewidths = 2)
    plt.scatter(X, Y, marker='o', s = size, linewidths = 1.5, color = "r", edgecolor='k', zorder = 5)
    plt.xlim( (0,1) )
    plt.ylim( (0,1) )
    plt.xticks([],[])
